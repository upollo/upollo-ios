...
public enum UpProto_EventType: SwiftProtobuf.Enum {
...
extension UpProto_EventType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [UpProto_EventType] = [
    .unspecified,
    .login,
    .register,
    .attemptPurchase,
...
public enum UpProto_Outcome: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case unspecified // = 0
  case deny // = 1
  case challenge // = 2
...
extension UpProto_Outcome: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [UpProto_Outcome] = [
    .unspecified,
    .deny,
    .challenge,
    .permit,
...
public enum UpProto_FlagType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case unspecified // = 0
...
extension UpProto_FlagType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [UpProto_FlagType] = [
    .unspecified,
    .accountSharing,
...
public enum UpProto_AddressType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case unspecified // = 0
  case home // = 1
  case work // = 2
...
extension UpProto_AddressType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [UpProto_AddressType] = [
    .unspecified,
    .home,
    .work,
    .other,
...
public enum UpProto_DeviceClass: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension UpProto_DeviceClass: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [UpProto_DeviceClass] = [
    .desktop,
    .mobile,
    .tablet,
    .goodbot,
...
public enum UpProto_ChallengeType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case unspecified // = 0
  case webauthn // = 1
  case sms // = 2
...
extension UpProto_ChallengeType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [UpProto_ChallengeType] = [
    .unspecified,
    .webauthn,
    .sms,
    .email,
...
public enum UpProto_EmailInvalidReason: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case unspecified // = 0
  case format // = 1
...
extension UpProto_EmailInvalidReason: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [UpProto_EmailInvalidReason] = [
    .unspecified,
    .format,
    .invalidDomain,
    .disposable,
...
public enum UpProto_PhoneLineType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case unspecified // = 0
  case mobile // = 1
  case landline // = 2
...
extension UpProto_PhoneLineType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [UpProto_PhoneLineType] = [
    .unspecified,
    .mobile,
    .landline,
    .voip,
...
public enum UpProto_PhoneInvalidReason: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case unspecified // = 0
  case numberFormat // = 1
  case inactiveLine // = 2
...
extension UpProto_PhoneInvalidReason: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [UpProto_PhoneInvalidReason] = [
    .unspecified,
    .numberFormat,
    .inactiveLine,
    .voip,
...
public enum UpProto_NullableBool: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case unspecified // = 0
  case `false` // = 1
  case `true` // = 2
...
extension UpProto_NullableBool: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [UpProto_NullableBool] = [
    .unspecified,
    .false,
    .true,
  ]
...
public struct UpProto_AnalysisResponse {
  ...
  public var userInfo: UpProto_UserInfo {
    get {return _storage._userInfo ?? UpProto_UserInfo()}
  ...
  public var deviceInfo: UpProto_DeviceInfo {
    get {return _storage._deviceInfo ?? UpProto_DeviceInfo()}
  ...
  public var geoInfo: UpProto_GeoInfo {
    get {return _storage._geoInfo ?? UpProto_GeoInfo()}
  ...
  public var supportedChallenges: [UpProto_ChallengeType] {
  ...
  public var eventType: UpProto_EventType {
...
public struct UpProto_EventResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct UpProto_Flag {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var type: UpProto_FlagType = .unspecified
...
public struct UpProto_UserInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var addresses: [UpProto_PhysicalAddress] = []
...
public struct UpProto_PhysicalAddress {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var type: UpProto_AddressType = .unspecified
...
public struct UpProto_DeviceInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var deviceClass: UpProto_DeviceClass = .desktop
...
public struct UpProto_GeoInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var geoIpLatlng: UpProto_LatLng {
    get {return _geoIpLatlng ?? UpProto_LatLng()}
  ...
  fileprivate var _geoIpLatlng: UpProto_LatLng? = nil
  fileprivate var _lastHere: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
}

public struct UpProto_LatLng {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct UpProto_Event {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var eventType: UpProto_Event.OneOf_EventType? = nil

  public var eventTypeEnum: UpProto_EventType {
    get {
  ...
  public enum OneOf_EventType: Equatable {
    case eventTypeEnum(UpProto_EventType)
    case customerDefinedEventType(String)

  #if !swift(>=4.1)
    public static func ==(lhs: UpProto_Event.OneOf_EventType, rhs: UpProto_Event.OneOf_EventType) -> Bool {
...
public struct UpProto_CheckEmailResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var reason: UpProto_EmailInvalidReason = .unspecified
...
public struct UpProto_CheckPasswordResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct UpProto_CheckPhoneResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var reason: UpProto_PhoneInvalidReason = .unspecified

  public var countryCode: String = String()

  public var lineType: UpProto_PhoneLineType = .unspecified
...
extension UpProto_EventType: @unchecked Sendable {}
extension UpProto_Outcome: @unchecked Sendable {}
extension UpProto_FlagType: @unchecked Sendable {}
extension UpProto_AddressType: @unchecked Sendable {}
extension UpProto_DeviceClass: @unchecked Sendable {}
extension UpProto_ChallengeType: @unchecked Sendable {}
extension UpProto_EmailInvalidReason: @unchecked Sendable {}
extension UpProto_PhoneLineType: @unchecked Sendable {}
extension UpProto_PhoneInvalidReason: @unchecked Sendable {}
extension UpProto_NullableBool: @unchecked Sendable {}
extension UpProto_AnalysisResponse: @unchecked Sendable {}
extension UpProto_EventResponse: @unchecked Sendable {}
extension UpProto_Flag: @unchecked Sendable {}
extension UpProto_Flags: @unchecked Sendable {}
extension UpProto_UserInfo: @unchecked Sendable {}
extension UpProto_PhysicalAddress: @unchecked Sendable {}
extension UpProto_DeviceInfo: @unchecked Sendable {}
extension UpProto_GeoInfo: @unchecked Sendable {}
extension UpProto_LatLng: @unchecked Sendable {}
extension UpProto_Event: @unchecked Sendable {}
extension UpProto_Event.OneOf_EventType: @unchecked Sendable {}
extension UpProto_CheckEmailResponse: @unchecked Sendable {}
extension UpProto_CheckPasswordResponse: @unchecked Sendable {}
extension UpProto_CheckPhoneResponse: @unchecked Sendable {}
...
extension UpProto_EventType: SwiftProtobuf._ProtoNameProviding {
...
extension UpProto_Outcome: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension UpProto_FlagType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension UpProto_AddressType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension UpProto_DeviceClass: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension UpProto_ChallengeType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension UpProto_EmailInvalidReason: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension UpProto_PhoneLineType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension UpProto_PhoneInvalidReason: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension UpProto_NullableBool: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension UpProto_AnalysisResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _action: UpProto_Outcome = .unspecified
    var _flags: [UpProto_Flag] = []
    var _isUsingVpn: Bool = false
    var _isUsingTor: Bool = false
    var _userInfo: UpProto_UserInfo? = nil
    var _deviceInfo: UpProto_DeviceInfo? = nil
    var _geoInfo: UpProto_GeoInfo? = nil
    var _supportedChallenges: [UpProto_ChallengeType] = []
    var _requestID: String = String()
    var _eventType: UpProto_EventType = .unspecified
  ...
  public static func ==(lhs: UpProto_AnalysisResponse, rhs: UpProto_AnalysisResponse) -> Bool {
...
extension UpProto_EventResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpProto_EventResponse, rhs: UpProto_EventResponse) -> Bool {
...
extension UpProto_Flag: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpProto_Flag, rhs: UpProto_Flag) -> Bool {
...
extension UpProto_Flags: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpProto_Flags, rhs: UpProto_Flags) -> Bool {
...
extension UpProto_UserInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpProto_UserInfo, rhs: UpProto_UserInfo) -> Bool {
...
extension UpProto_PhysicalAddress: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpProto_PhysicalAddress, rhs: UpProto_PhysicalAddress) -> Bool {
    if lhs.type != rhs.type {return false}
...
extension UpProto_DeviceInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpProto_DeviceInfo, rhs: UpProto_DeviceInfo) -> Bool {
...
extension UpProto_GeoInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpProto_GeoInfo, rhs: UpProto_GeoInfo) -> Bool {
...
extension UpProto_LatLng: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpProto_LatLng, rhs: UpProto_LatLng) -> Bool {
...
extension UpProto_Event: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpProto_Event, rhs: UpProto_Event) -> Bool {
...
extension UpProto_CheckEmailResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpProto_CheckEmailResponse, rhs: UpProto_CheckEmailResponse) -> Bool {
...
extension UpProto_CheckPasswordResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpProto_CheckPasswordResponse, rhs: UpProto_CheckPasswordResponse) -> Bool {
...
extension UpProto_CheckPhoneResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpProto_CheckPhoneResponse, rhs: UpProto_CheckPhoneResponse) -> Bool {
    if lhs.valid != rhs.valid {return false}
    if lhs.reason != rhs.reason {return false}
